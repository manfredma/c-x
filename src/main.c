...
void print_usage(const char *program_name) {
    ...
    printf("API 使用说明:\n");
    printf("  GET /key      - 获取键值\n");
    printf("  POST /key     - 设置键值 (请求体为值)\n");
    printf("  DELETE /key   - 删除键值\n");
    printf("\n");
    printf("测试示例:\n");
    printf("  curl -X POST http://localhost:8080/mykey -d 'myvalue'\n");
    printf("  curl http://localhost:8080/mykey\n");
    printf("  curl -X DELETE http://localhost:8080/mykey\n");
}
